...
from oyez.schemas.session import SubtopicProgress
from oyez.services.fixtures import load_fixture
...
async def generate_lesson_plan(
    ...
    from oyez.config import get_settings
